...
# TODO: Use the KnowledgeUnitsFactory inside the service layer
...
def get_document_service(
    ...
    return DocumentService(repo, text_embedder, image_embedder, openai_client, azure_blob_storage, ku_factory)
