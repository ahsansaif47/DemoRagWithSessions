...
def init_azure_storage_service() -> AzureStorageService:
    ...
    return AzureStorageService(
        ...
        image_container_name=blob_storage_config.image_container
    )

def get_azure_storage_service(request: Request) -> AzureStorageService:
    return request.app.state.azure_storage_service
